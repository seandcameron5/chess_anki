...
params = []
for i in range(len(notes)):
    params.append(generate_params(deckName=opening, fields=["Move", "Response", "Comments"], file_names=[opening+f'{i}'+'f.svg', opening+f'{i}'+'b.svg'], field_texts=["", "" ,notes[i][2] + "\n\n\n" + notes[i][3] + "\n\n\n"]))
